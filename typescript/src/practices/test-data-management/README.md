# Test Data Management — TypeScript

The runnable sample for **[Test Data Management](https://endtoendtester.com/practices/test-data-management)**.
...
- [Python](../../../../python/tests/practices/test-data-management)
