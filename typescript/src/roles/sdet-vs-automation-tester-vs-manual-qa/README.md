# Sdet Vs Automation Tester Vs Manual Qa — TypeScript

The runnable sample for **[Sdet Vs Automation Tester Vs Manual Qa](https://endtoendtester.com/roles/sdet-vs-automation-tester-vs-manual-qa)**.
