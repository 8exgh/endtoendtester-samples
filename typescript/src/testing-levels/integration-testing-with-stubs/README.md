# Integration Testing With Stubs — TypeScript

The runnable sample for **[Integration Testing With Stubs](https://endtoendtester.com/testing-levels/integration-testing-with-stubs)**.
