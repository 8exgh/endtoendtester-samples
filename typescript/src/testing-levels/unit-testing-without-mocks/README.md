# Unit Testing Without Mocks — TypeScript

The runnable sample for **[Unit Testing Without Mocks](https://endtoendtester.com/testing-levels/unit-testing-without-mocks)**.
